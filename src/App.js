// Published URL ==>  https://saiprojectsapp.ccbp.tech
...
class App extends Component {
  ...
  updateProjectResults = tabId => this.setState({activeTabId: tabId})

  render() {
    const filteredProjects = this.filterProjectResults()
    const {activeTabId} = this.state
